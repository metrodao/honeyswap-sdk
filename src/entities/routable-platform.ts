...
const SUSHISWAP_FANTOM_FACTORY_ADDRESS = '0xc35DADB65012eC5796536bD9864eD8773aBc74C4'
...
const POLYCAT_MATIC_FACTORY_ADDRESS = '0x477Ce834Ae6b7aB003cCe4BC4d8697763FF456FA'
const SPOOKYFI_FANTOM_FACTORY_ADDRESS = '0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3'
const TOMBSWAP_FANTOM_FACTORY_ADDRESS = '0xE236f6890F1824fa0a7ffc39b1597A5A6077Cfe9'
const DEFIKINGDOMS_HARMONY_FACTORY_ADDRESS = '0x9014B937069918bd319f80e8B3BB4A2cf6FAA5F7'
...
const SUSHISWAP_FANTOM_ROUTER_ADDRESS = '0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506'
...
const POLYCAT_MATIC_ROUTER_ADDRESS = '0x94930a328162957FF1dd48900aF67B5439336cBD'
const SPOOKYFI_FANTOM_ROUTER_ADDRESS = '0xF491e7B69E4244ad4002BC14e878a34207E38c29'
const TOMBSWAP_FANTOM_ROUTER_ADDRESS = '0x6D0176C5ea1e44b08D3dd001b0784cE42F47a3A7'
const DEFIKINGDOMS_HARMONY_ROUTER_ADDRESS = '0x24ad62502d1C652Cc7684081169D04896aC20f30'
...
export class RoutablePlatform {
  ...
  public static readonly HONEYSWAP = new RoutablePlatform(
    ...
    { 
      ...
      [ChainId.ETF]: HONEYSWAP_FACTORY_ADDRESS,
    ...
    { 
      ...
      [ChainId.ETF]: HONEYSWAP_ROUTER_ADDRESS,
    ...
    { 
      ...
      [ChainId.ETF]: '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776',
  ...
  public static readonly UNISWAP = new RoutablePlatform(
    ...
    },
    {
      ...
      [ChainId.ETF]: '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f'
    },
    _30
  )
  public static readonly SUSHISWAP = new RoutablePlatform(
    ...
    { 
      ...
      [ChainId.ETF]: SUSHISWAP_FACTORY_ADDRESS,
      ...
      [ChainId.FANTOM]: SUSHISWAP_FANTOM_FACTORY_ADDRESS
    },
    { 
      [ChainId.MAINNET]: SUSHISWAP_ROUTER_ADDRESS, 
      [ChainId.ETHW]: SUSHISWAP_ROUTER_ADDRESS,
      [ChainId.ETF]: SUSHISWAP_ROUTER_ADDRESS,
      ...
      [ChainId.XDAI]: SUSHISWAP_FANTOM_ROUTER_ADDRESS
    },
    { 
      ...
      [ChainId.ETF]: '0xe18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303',
  ...
  public static readonly POLYCAT = new RoutablePlatform(
    'Polycat',
    { 
      [ChainId.MATIC]: POLYCAT_MATIC_FACTORY_ADDRESS
    },
    { 
      [ChainId.MATIC]: POLYCAT_MATIC_ROUTER_ADDRESS
    },
    { 
      [ChainId.MATIC]: '0x3cad6f9e70e13835b4f07e5dd475f25a109450b22811d0437da51e66c161255a'
    },
    _30
  )
  public static readonly SPOOKYFI = new RoutablePlatform(
    'SpookyFi',
    { 
      [ChainId.FANTOM]: SPOOKYFI_FANTOM_FACTORY_ADDRESS
    },
    { 
      [ChainId.FANTOM]: SPOOKYFI_FANTOM_ROUTER_ADDRESS
    },
    { 
  ...
  public static readonly TOMBSWAP = new RoutablePlatform(
    'TombSwap',
    { 
      [ChainId.FANTOM]: TOMBSWAP_FANTOM_FACTORY_ADDRESS
    },
    { 
  ...
  public static readonly DEFIKINGDOMS = new RoutablePlatform(
    'DefiKingdoms',
    { 
      [ChainId.HARMONY]: DEFIKINGDOMS_HARMONY_FACTORY_ADDRESS
    },
    { 
      [ChainId.HARMONY]: DEFIKINGDOMS_HARMONY_ROUTER_ADDRESS
    },
    { 
      [ChainId.HARMONY]: '0xf1c21a825f13eff153022ddea53156462dd79972b6f88adf06f79ca8b042c3c1'
    },
    _30
  )
